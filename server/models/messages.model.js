    ...
    deleteMessageRecord = async (message_id, user_id) => {
        ...
        try{
            ...
            if(delete_message_response.affectedRows){
                let delete_comments_query = mysqlFormat(`DELETE FROM comments WHERE message_id = ?`, [message_id]);
                let delete_comments_response = await queryModel.executeQuery(delete_comments_query);
            }
